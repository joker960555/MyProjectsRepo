...
/***/ "./src/js/modules/formInputCheck.js":
/*!******************************************!*\
  !*** ./src/js/modules/formInputCheck.js ***!
  \******************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (formInputCheck);
...
/* harmony import */ var _formInputCheck__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./formInputCheck */ "./src/js/modules/formInputCheck.js");
...
function forms(state) {
  ...
  Object(_formInputCheck__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  ...
  function formInput() {
    ...
    forms.forEach(function (item) {
      item.addEventListener('submit', function (event) {
        ...
        postData(formData, 'assets/server.php').then(function (data) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 5;
            return regeneratorRuntime.awrap(responce.text());
...
/***/ "./src/js/modules/modalStateChanges.js":
/*!*********************************************!*\
  !*** ./src/js/modules/modalStateChanges.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var _formInputCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formInputCheck */ "./src/js/modules/formInputCheck.js");



function modalStateChanges(state) {
  var windowForm = document.querySelectorAll('.balcon_icons_img'),
      windowWidth = document.querySelectorAll('#width'),
      windowHeight = document.querySelectorAll('#height'),
      windowType = document.querySelectorAll('#view_type'),
      windowProfile = document.querySelectorAll('.checkbox');
  Object(_formInputCheck__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_formInputCheck__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');
...
/* harmony default export */ __webpack_exports__["default"] = (modalStateChanges);
...
function modals() {
  ...
  function triggerPush(selectorTrigg, selectorModal, selectorClose) {
    ...
    if (modal.classList.contains('popup')) {
      setTimeout(function () {
        return openModal(modal, selectorModal, selectorClose, clickCloseOverlay);
      }, 600000);
    }
...
var timer = function timer(deadline) {
  ...
  var setClock = function setClock(deadline) {
    ...
    function updateClock() {
      var date = getTimeRemaining(deadline);
