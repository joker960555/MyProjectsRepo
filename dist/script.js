...
var modals = function modals() {
  function bindOpenModal(selectorOpen, selectorModal, selectorClose) {
    var openModal = document.querySelectorAll(selectorOpen),
  ...
  bindOpenModal('.phone_link', '.popup', '.popup .popup_close'); // modalTimeout('.popup', 60000);
};
...
var tabs = function tabs(tabsSelector, contentSelector, headerSelector, activeClass) {
  var tab = document.querySelectorAll(tabsSelector),
  ...
  function showTab() {
    header.addEventListener('click', function (event) {
      ...
      if (e && (e.classList.contains(tabsSelector.replace(/\./, '')) || e.parentNode.classList.contains(tabsSelector.replace(/\./, '')))) {
